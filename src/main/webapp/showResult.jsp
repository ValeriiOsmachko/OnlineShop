...
<body>
	...
	<div class="container">
		<h2 class="text-center">Thank you for cooperation</h2>
		<h3 class="text-left">Identifier of you order is:
			${sessionScope.ORDER.id}</h3>
		<h3 class="text-left">Delivery address:
			${sessionScope.ORDER.address}</h3>
		...
		<p class="text-left">Total price of your order is:
			${sessionScope.cart.countTotalPriceFromCart()}</p>
	</div>
	...
	<div class=" container">
		...
		<div class="col-md-6 register-bottom-grid">
			...
			<button class="btn btn-primary center-block" type="submit">ON THE MAIN PAGE</button>
			</form>
		</div>
	</div>
	<!--//content-->
